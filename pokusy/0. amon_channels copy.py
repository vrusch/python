...
with open(inputfile, 'r') as csvfile:
    ...
    for row in csvreader:
        ...
        scr_num = scr_num+1
        test_list_sentense2 = "./KALT_play_live_channel_"+chanel_na+"_HLS.yaml "+str(scr_num)+" 3 "+operator_code+" "+chanel_id+ "\n"
        ...
        #./KALT_play_live_1_RTS_1_DASH.yml 100 3 3200 800398
        scr_num = scr_num+1
        test_list_sentense2 = "./KALT_play_live_channel_"+chanel_na+"_DASH.yaml "+str(scr_num)+" 3 "+operator_code+" "+chanel_id+ "\n"
        #./BRPK_play_live_1_RTS_1_DASH.yml 101 3 3200
        scr_num = scr_num+1
