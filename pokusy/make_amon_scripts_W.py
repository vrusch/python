...
with open(inputfile, 'r') as csvfile:
    ...
    for row in csvreader:
        ...
        dir_name_hls = operator+"-channel-"+chanel_nu+"_"+chanel_na+"_HLS"
        ...
        kalt_f_name = os.path.join(dir_path, "KALT_play_live_channel_"+chanel_nu+"_"+chanel_na+"_HLS.yaml")
        brpk_f_name = os.path.join(dir_path, "BRPK_play_live_channel_"+chanel_nu+"_"+chanel_na+"_HLS.yaml")
        ...
        scr_num = scr_num+1
        test_list_sentense2 = "./KALT_play_live_channel_"+chanel_nu+"_"+chanel_na+"_HLS.yaml "+str(scr_num)+" 3 "+operator_code+" "+chanel_id+ "\n"
        #./BRPK_play_live_1_RTS_1_DASH.yml 101 3 3200
        scr_num = scr_num+1
        test_list_sentense3 = "./BRPK_play_live_channel_"+chanel_nu+"_"+chanel_na+"_HLS.yaml "+str(scr_num)+" 3 "+operator_code+"\n"
        ...
        dir_name_dash = operator+"-channel-"+chanel_nu+"_"+chanel_na+"_DASH"
        ...
        print("file --> "  +os.path.join(dir_path, "defaults.include") + "  was copied")
        logging.info("file --> "  +os.path.join(dir_path, "defaults.include") + "  was copied")
        kalt_f_name = os.path.join(dir_path, "KALT_play_live_channel_"+chanel_nu+"_"+chanel_na+"_DASH.yaml")
        brpk_f_name = os.path.join(dir_path, "BRPK_play_live_channel_"+chanel_nu+"_"+chanel_na+"_DASH.yaml")       
        shutil.copy(os.path.join(proto_dir, "main.lua"), os.path.join(dir_path, "main.lua"))
        print("file --> " + os.path.join(dir_path, "main.lua") + "  was copied") 
        logging.info("file --> " + os.path.join(dir_path, "main.lua") + "  was copied")       
        ...
        #./KALT_play_live_1_RTS_1_DASH.yml 100 3 3200 800398
        scr_num = scr_num+1
        test_list_sentense2 = "./KALT_play_live_channel_"+chanel_nu+"_"+chanel_na+"_DASH.yaml "+str(scr_num)+" 3 "+operator_code+" "+chanel_id+ "\n"
        #./BRPK_play_live_1_RTS_1_DASH.yml 101 3 3200
        scr_num = scr_num+1
        test_list_sentense3 = "./BRPK_play_live_channel_"+chanel_nu+"_"+chanel_na+"_DASH.yaml "+str(scr_num)+" 3 "+operator_code+"\n"
